...
public class PersistentCookieStore implements CookieStore {
    ...
    /**
     * Get the real URI from the cookie "domain" and "path" attributes, if they are not set then uses
    ...
    private void saveToPersistence(URI uri, HttpCookie cookie) {
        ...
        editor.putString(
                uri.toString() + SP_KEY_DELIMITER + cookie.getName(),
    ...
    public HashMap<String, String> getKeyRequestProperties() {
        HashMap<String, String> keyRequestProperties = null;
